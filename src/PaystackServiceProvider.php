...
class PaystackServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->alias('paystack', \HelloFromSteve\Paystack\PaystackService::class);
    }
    ...
    // There is no need to register publishing logic for web requests
        ...
        $this->app['router']->aliasMiddleware('paystack.webhook', \HelloFromSteve\Paystack\Middleware\VerifyPaystackWebhook::class);
    }
}
